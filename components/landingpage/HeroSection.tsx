...
export default function HeroSection() {
  return (
    <header className="h-auto gap-16 lg:block pb-36">
      <div className="font-rubikGlitch ">
        <h2 className="text-[125px] text-[#545353] -mb-12">When You</h2>
        {/* TODO: Add :before and :after for gradient shadow */}
        <h2 className="text-[150px] text-center -mb-12">Ladder It</h2>
        <h2 className="text-[125px] text-[#545353] text-right mt-2">You Gather It</h2>
      </div>
