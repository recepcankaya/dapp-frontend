...
export default function HeroSection() {
  ...
  return (
    <header className="relative h-[400px] lg:h-[847px] font-bold">
      <Image
        src={bubbleBg}
        alt="bubbles"
        className="absolute top-0 left-0 w-full h-full opacity-10 object-cover"
      />
      <h2 className="text-2xl sm:text-4xl lg:text-5xl font-holtwood text-center pt-12 lg:absolute lg:top-32 lg:left-28 animate-visibleHeroH2">
        WHEN YOU LADDER IT
      </h2>
      <h2
        ref={secondH2Ref}
